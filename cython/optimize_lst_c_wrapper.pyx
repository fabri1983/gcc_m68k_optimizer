...
cdef int _c_optimize_file(const char* input_filename,
                         const char* output_filename,
                         const char* symbols_opt_filename,
                         const char* symbols_canonical_filename) except -1:
    """
    Wrapper function that converts C strings to Python strings and calls the Python optimize_file function.
    """
...
cdef public int c_optimize_file(const char* input_filename,
                               ...
                               const char* symbols_opt_filename,
                               const char* symbols_canonical_filename) except -1:
    return _c_optimize_file(input_filename, output_filename, 
                           symbols_opt_filename, symbols_canonical_filename)